...
const SidebarGroupAction = React.forwardRef<HTMLElement, SidebarGroupActionProps>(
  ({ className, asChild = false, ...props }, ref) => {
...
const SidebarMenuAction = React.forwardRef<HTMLElement, SidebarMenuActionProps>(
