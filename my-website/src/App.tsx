...
import { ModernWeeklyPlanner } from './components/modern-weekly-planner';
...
import { AddPlanPage } from './components/add-plan-page';
import { PlanManagerPage } from './components/plan-manager-page';
